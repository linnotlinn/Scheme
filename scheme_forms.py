...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        new_expressions = Pair(signature.rest, expressions.rest)
...
def do_and_form(expressions, env):
    ...
    if is_scheme_false(first_expression):
        return False
    elif is_scheme_true(first_expression) and expressions.rest is nil:
...
def do_or_form(expressions, env):
    ...
    if expressions is nil:
        return False
    first_expression = scheme_eval(expressions.first, env)
    if is_scheme_true(first_expression):
        return first_expression
    elif is_scheme_false(first_expression):
...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        first_formal = first.first
        first_value = first.rest
        names = Pair(first_formal, names)
        vals = Pair(eval_all(first_value, env), vals)
